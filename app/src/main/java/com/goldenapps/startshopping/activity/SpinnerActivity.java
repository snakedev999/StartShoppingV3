...
public class SpinnerActivity extends AppCompatActivity {
    ...
    TextView oDataRegion;
    Spinner oSpinnerRegion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oDataRegion = findViewById(R.id.tv_spinnerRegion);
        oSpinnerRegion = findViewById(R.id.spinnerRegion);
        ...
        databaseReference.child("Region").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    oSpinnerRegion.setAdapter(regionArrayAdapter);
                    oSpinnerRegion.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                            regionSeleccionada = adapterView.getItemAtPosition(i).toString();
                            String id = regiones.get(i).getIdRegion();
                            oDataRegion.setText(regionSeleccionada+" "+id);
                        }
